...
const uint8_t pin_led = D3;
const uint8_t pin_key = D5;
const uint8_t pin_inh = D6;
const uint8_t pin_A = D0;
const uint8_t pin_B = D1;
const uint8_t pin_C = D2;
